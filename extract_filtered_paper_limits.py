...
def main():
    ...
    parser.add_argument("--dir", type=str, default="Paper", help="Directory containing the recalibrate_limits CSV logs")
    parser.add_argument("--out", type=str, default="filtered_paper_limits.json", help="Output JSON path")
